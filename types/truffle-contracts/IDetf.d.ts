...
export interface IDetfContract extends Truffle.Contract<IDetfInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<IDetfInstance>;
}
...
export interface IDetfInstance extends Truffle.ContractInstance {
  /**
