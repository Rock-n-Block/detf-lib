...
var AdminRole_abi_1 = require("./AdminRole.abi");
var DEFAULT_GAS_ESTIMATION_MULTIPLAYER = 1.1; // + 10 %
var AdminRole = /** @class */ (function () {
    function AdminRole(_a) {
        var address = _a.address, web3 = _a.web3, sender = _a.sender, gasEstimationMultiplayer = _a.gasEstimationMultiplayer;
        this._sender = sender;
        this.native = new web3.eth.Contract(AdminRole_abi_1.Abi, address);
    ...
    Object.defineProperty(AdminRole.prototype, "sender", {
        get: function () {
            if (this._sender)
                return this._sender;
    ...
    AdminRole.prototype.getSenderOrFail = function () {
    ...
    AdminRole.prototype.estimateGas = function (method, args) {
    ...
    AdminRole.prototype.isAdmin = function (account) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    AdminRole.prototype.addAdmin = function (account) {
        return __awaiter(this, void 0, void 0, function () {
            var method, _a, _b;
            var _c;
    ...
    AdminRole.prototype.renounceAdmin = function () {
        return __awaiter(this, void 0, void 0, function () {
            var method, _a, _b;
            var _c;
            return __generator(this, function (_d) {
