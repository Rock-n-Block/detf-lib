...
exports.GovernorEvents = void 0;
var bn_js_1 = __importDefault(require("bn.js"));
var GovernorEvents_abi_1 = require("./GovernorEvents.abi");
var DEFAULT_GAS_ESTIMATION_MULTIPLAYER = 1.1; // + 10 %
var GovernorEvents = /** @class */ (function () {
    function GovernorEvents(_a) {
        var address = _a.address, web3 = _a.web3, sender = _a.sender, gasEstimationMultiplayer = _a.gasEstimationMultiplayer;
        this._sender = sender;
        this.native = new web3.eth.Contract(GovernorEvents_abi_1.Abi, address);
    ...
    Object.defineProperty(GovernorEvents.prototype, "sender", {
        get: function () {
            if (this._sender)
                return this._sender;
    ...
    GovernorEvents.prototype.getSenderOrFail = function () {
    ...
    GovernorEvents.prototype.estimateGas = function (method, args) {
    ...
    return GovernorEvents;
}());
exports.GovernorEvents = GovernorEvents;
