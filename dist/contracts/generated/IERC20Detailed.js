...
var IERC20Detailed_abi_1 = require("./IERC20Detailed.abi");
var DEFAULT_GAS_ESTIMATION_MULTIPLAYER = 1.1; // + 10 %
var Ierc20Detailed = /** @class */ (function () {
    function Ierc20Detailed(_a) {
        var address = _a.address, web3 = _a.web3, sender = _a.sender, gasEstimationMultiplayer = _a.gasEstimationMultiplayer;
        this._sender = sender;
        this.native = new web3.eth.Contract(IERC20Detailed_abi_1.Abi, address);
    ...
    Object.defineProperty(Ierc20Detailed.prototype, "sender", {
        get: function () {
            if (this._sender)
                return this._sender;
    ...
    Ierc20Detailed.prototype.getSenderOrFail = function () {
    ...
    Ierc20Detailed.prototype.estimateGas = function (method, args) {
    ...
    Ierc20Detailed.prototype.allowance = function (owner, spender) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    Ierc20Detailed.prototype.approve = function (spender, amount) {
        return __awaiter(this, void 0, void 0, function () {
            var method, _a, _b;
            var _c;
    ...
    Ierc20Detailed.prototype.balanceOf = function (account) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    Ierc20Detailed.prototype.totalSupply = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    Ierc20Detailed.prototype.transferFrom = function (sender, recipient, amount) {
        return __awaiter(this, void 0, void 0, function () {
            var method, _a, _b;
            var _c;
            return __generator(this, function (_d) {
    ...
    Ierc20Detailed.prototype.name = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    Ierc20Detailed.prototype.symbol = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
