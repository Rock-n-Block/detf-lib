...
export const Abi = [
  {
    inputs: [
      { internalType: "address", name: "uniswapV2Router_", type: "address" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint256", name: "rFee", type: "uint256" }
    ],
  ...
  },
  {
    ...
    name: "checkpoints",
    outputs: [
      { internalType: "uint256", name: "fromBlock", type: "uint256" },
  ...
  {
    inputs: [{ internalType: "address", name: "account", type: "address" }],
    name: "excludeAccountFromRewards",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function"
  },
